...
- Scraping note: Excluded from live daily report. Reason: Reachable source, but excluded from the live daily report because it often adds broader policy/transition coverage rather than short-cycle crude/products market signal.
- Source note: Reachable source, but excluded from the live daily report because it often adds broader policy/transition coverage rather than short-cycle crude/products market signal.
...
- OPEC&apos;s name in white on a background of blue showing the group&apos;s symbol next to three silhouettes of drilling rigs in black.
